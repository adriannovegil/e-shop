...
public class AxonConfig {
    ...
    /**
     * Configures a snapshot trigger to create a Snapshot every 5 events. 5 is
     * an arbitrary number used only for testing purposes just to show how the
     * snapshots are stored on Mongo as well.
     */
//  @Bean
