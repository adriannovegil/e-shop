...
/**
 * Provides implementation for handling duplicate request and ensuring
 * idempotent updates, in the cases where a requestid sent by client is used to
...
public class CommandBusImpl implements CommandBus {
    ...
    public <R, C extends Command<R>> R send(C c) {
        if (c instanceof IdentifiedCommand<?, ?> 
