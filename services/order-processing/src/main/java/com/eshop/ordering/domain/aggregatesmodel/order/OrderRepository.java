 ...
 * <p>
 * Dispatch Domain Events collection. Choices: A) Right BEFORE committing data
 * into the DB will make a single transaction including side effects from the
 * domain event handlers which are using the same DbContext with
 ...
 * of failures in any of the Handlers.
 */
