 ...
 * {@link #addDomainEvent(DomainEvent)} to capture domain events and expose them
...
public abstract class AggregateRoot<ID extends Identifier> extends Entity<ID> {
     ...
     * Data repository's save methods.
     *
    ...
    /**
     * Remove the given event object from the list of domain events currently
     * held.
     *
     * @param event must not be {@literal null}.
     */
